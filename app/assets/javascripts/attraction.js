...
App.Attraction.prototype.buildListItem = function() {
  ...
  var li = $('<li><span class="small-6 columns attr_name">' + this.attrData.name + '<p>' + 'City: ' + this.attrData.city + ', ' + this.attrData.state + ' | Yelp Rating: ' + this.attrData.rating + '</p>' +'</span></li>')
